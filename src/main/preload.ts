...
const accountWorkbench = {
  ...
  openProfileTemplate: () => ipcRenderer.invoke("profiles:open-template"),
  openCameraPermissions: () => ipcRenderer.invoke("system:open-camera-permissions"),
  ...
  resetAccountProfileFromTemplate: (accountId: string) => ipcRenderer.invoke("profiles:reset-account-from-template", accountId),
